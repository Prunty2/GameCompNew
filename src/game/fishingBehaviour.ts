...
export const FISHING_SPECIES_FIGHT_PROFILES: Record<FishSpecies, FishingSpeciesFightProfile> = {
  ...
  whiteSucker: {
    style: "bottom-power", cycleSeconds: 4.7, runFraction: 0.26, thrashFraction: 0.12,
    runIntensity: 0.7, thrashIntensity: 0.54, runPower: 0.94, thrashPower: 0.82,
    reelResistance: 1.08, endurance: 1.02, recovery: 0.84, runSlip: 0.72, runSlack: 0.88,
  ...
  atlanticSpadefish: {
    style: "steady-school", cycleSeconds: 4, runFraction: 0.22, thrashFraction: 0.16,
    runIntensity: 0.68, thrashIntensity: 0.62, runPower: 0.88, thrashPower: 0.9,
    reelResistance: 1.04, endurance: 0.96, recovery: 0.9, runSlip: 0.84, runSlack: 0.96,
    horizontalRange: 0.075, verticalRange: 0.034, runDepthBias: 0.01,
    pathFrequency: 0.62, steeringResponse: 3.7, motionDamping: 5.1, maximumSpeed: 0.23,
    wriggleFrequency: 10, wriggleAmplitude: 0.14,
  },
  sheepshead: {
    style: "bottom-power", cycleSeconds: 4.8, runFraction: 0.29, thrashFraction: 0.14,
    runIntensity: 0.8, thrashIntensity: 0.66, runPower: 1.08, thrashPower: 0.94,
    reelResistance: 1.18, endurance: 1.06, recovery: 0.82, runSlip: 0.82, runSlack: 0.86,
    horizontalRange: 0.095, verticalRange: 0.032, runDepthBias: 0.055,
    pathFrequency: 0.46, steeringResponse: 3.5, motionDamping: 4.9, maximumSpeed: 0.27,
    wriggleFrequency: 9, wriggleAmplitude: 0.16,
  },
  grayTriggerfish: {
    style: "rolling-power", cycleSeconds: 4.55, runFraction: 0.27, thrashFraction: 0.24,
    runIntensity: 0.82, thrashIntensity: 0.9, runPower: 1.12, thrashPower: 1.16,
    reelResistance: 1.24, endurance: 1.08, recovery: 0.8, runSlip: 0.82, runSlack: 0.84,
    horizontalRange: 0.09, verticalRange: 0.06, runDepthBias: 0.045,
    pathFrequency: 0.6, steeringResponse: 3.8, motionDamping: 4.6, maximumSpeed: 0.28,
    wriggleFrequency: 12.6, wriggleAmplitude: 0.26,
  },
  cobia: {
    style: "deep-sustained", cycleSeconds: 5.65, runFraction: 0.38, thrashFraction: 0.11,
    runIntensity: 0.94, thrashIntensity: 0.68, runPower: 1.28, thrashPower: 1,
    reelResistance: 1.34, endurance: 1.16, recovery: 0.76, runSlip: 0.78, runSlack: 0.76,
    horizontalRange: 0.145, verticalRange: 0.055, runDepthBias: 0.055,
    pathFrequency: 0.48, steeringResponse: 3.8, motionDamping: 4.4, maximumSpeed: 0.34,
    wriggleFrequency: 8.4, wriggleAmplitude: 0.18,
  },
  greaterAmberjack: {
    style: "power-dive", cycleSeconds: 5.7, runFraction: 0.44, thrashFraction: 0.1,
    runIntensity: 1, thrashIntensity: 0.72, runPower: 1.42, thrashPower: 1.04,
    reelResistance: 1.48, endurance: 1.22, recovery: 0.72, runSlip: 0.76, runSlack: 0.7,
    horizontalRange: 0.165, verticalRange: 0.09, runDepthBias: 0.11,
    pathFrequency: 0.68, steeringResponse: 4.5, motionDamping: 4.2, maximumSpeed: 0.44,
    wriggleFrequency: 13.4, wriggleAmplitude: 0.21,
  },
  atlanticMahiMahi: {
    style: "leaping-thrash", cycleSeconds: 5.1, runFraction: 0.43, thrashFraction: 0.2,
    runIntensity: 1, thrashIntensity: 0.96, runPower: 1.48, thrashPower: 1.24,
    reelResistance: 1.55, endurance: 1.24, recovery: 0.7, runSlip: 0.72, runSlack: 0.68,
    horizontalRange: 0.18, verticalRange: 0.12, runDepthBias: -0.07,
    pathFrequency: 1.02, steeringResponse: 5.1, motionDamping: 4.1, maximumSpeed: 0.5,
    wriggleFrequency: 17.5, wriggleAmplitude: 0.25,
  },
};
