    ...
    const contractMarkup = available
      ? `<div class="contract-card job-ticket ${isFirstJobOffer ? "is-guided" : ""}">
          ...
          <ol class="job-route" aria-label="Job steps">
            ...
            <li><span class="job-route-number" aria-hidden="true">02</span><div class="job-route-copy"><small>Freshness</small><img class="job-route-icon job-route-freshness-icon" src="${freshnessFishIconUrl}" alt="" aria-hidden="true" /><strong>Every fish</strong><span class="job-route-detail">${available.minimumFreshness}%+ · ${available.reducedReward} if missed</span></div></li>
      ...
      : contract
        ? `<div class="contract-card job-ticket ${deliverable ? "is-ready" : ""}">
            ...
            <ol class="job-route" aria-label="Job steps">
              ...
              <li class="${freshCatch ? "is-complete" : matchingCatch ? "is-current" : ""}"><span class="job-route-number" aria-hidden="true">${freshCatch ? "✓" : "02"}</span><div class="job-route-copy"><small>Freshness</small><img class="job-route-icon job-route-freshness-icon" src="${freshnessFishIconUrl}" alt="" aria-hidden="true" /><strong>Every fish</strong><span class="job-route-detail">${contract.minimumFreshness}%+ · ${contract.reducedReward} if missed</span></div></li>
