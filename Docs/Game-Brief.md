...
9. The fish follows the rising hook on a taut line with a restrained struggle, then enters cargo when the reel completes. Reduced-motion mode removes the struggle while keeping the hooked and secured states readable.
