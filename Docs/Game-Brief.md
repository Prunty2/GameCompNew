...
Full hook input moves at 0.34 normalized fishing-view units per second on both axes. This deliberately slower steering rate gives players time to make controlled approaches without changing fish speed, catch radius, or line-depth progression.
