...
6. The camera eases downward through the same painted waterline used while sailing, briefly retaining the boat and shoreline above the surface before the underwater play space takes over. Reduced-motion mode shows the settled underwater framing immediately.
