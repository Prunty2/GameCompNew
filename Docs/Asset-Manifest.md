...
- Generated and runtime size: 1672 × 941 for both plates, exactly matching the lake panorama's runtime dimensions, camera crop, and waterline calculations
- Generated on: 14 August 2026 with OpenAI's built-in image-generation tool
- Generation mode: the daytime plate was generated with `lake-chart.png` as the authoritative style, camera, world-scale, waterline, palette, and readability reference; the night plate is a lighting-weather edit of the generated daytime Beach plate
- Day prompt: “Use case: stylized-concept. Asset type: production runtime panorama for the side-scrolling 2D browser game FSHING. Image 1 is the authoritative reference for painting style, camera, world scale, waterline placement, quiet atmospheric depth, palette restraint, and open gameplay readability only; create an original new location rather than editing or copying its lake geography. Create a seaside town called Beach, with a surf club, pier, and fish-and-chip shop on the far left and a lighthouse on the far right. A calm coastal bay with a broad sandy beach and low seaside town is viewed from across the water. On the far left, include a modest weatherboard surf lifesaving club, a narrow timber pier extending rightward over the water, and a small fish-and-chip shop with a restrained striped awning and serving window. On the far right, include a tall weathered lighthouse on a low rocky headland. Keep the middle mostly open water and distant beach so a player boat and gameplay markers remain readable. Use restrained editorial gouache and screen-print illustration matching Image 1, with simplified shapes, soft dry-brush edges, subtle aged-paper grain, and atmospheric layers. Strict side-on landscape panorama, not top-down and not isometric. Match Image 1's wide 1672 × 941 aspect ratio, camera height, landmark scale, horizon depth, and crisp waterline at about 61 percent of image height. Full bleed. Left landmarks stay within the outer left quarter; lighthouse stays within the outer right quarter; unobstructed navigable water spans the full width. Quiet overcast late-afternoon coastal light. Muted slate blue and sea teal, weathered cream, sandy ochre, subdued coral and sparse safety-orange accents. Weathered painted timber, narrow pier planks and pilings at believable boat scale, sand, dune grass, dark coastal rock, and painted masonry lighthouse. Exactly one continuous coherent seaside world background. No player boat, fish, people, vehicles, text, readable shop signage, logo, UI, labels, borders, map, or watermark. Do not place obstacles in the open water. Preserve ample calm water below the waterline for gameplay. Make the surf club, pier, fish-and-chip shop, beach, town, and lighthouse all visibly distinct at gameplay scale. Avoid photorealism, glossy 3D, cartoon outlines, tropical resort imagery, crowded skyline, giant buildings, close-up structures, dramatic storm, crashing waves, duplicated lighthouses, and center foreground landmarks.”
- Night prompt: “Use case: lighting-weather. Asset type: runtime side-scrolling game panorama, nighttime counterpart to the supplied Beach daytime background. Image 1 is the edit target and authoritative daytime Beach composition. Transform only the time of day from quiet overcast late afternoon to atmospheric deep coastal night. Preserve exactly the existing camera, 1672 × 941 aspect ratio, horizon, waterline, surf club, fish-and-chip shop, pier, beach, town, lighthouse, rocks, every object's placement and scale, and all open gameplay water. Use cool blue-black moonless ambient light, darker but readable silhouettes, a restrained warm surf-club window glow, a small warm shop glow, and one believable lighthouse lamp glow with subtle narrow reflections. No moon, boat, fish, people, characters, text, UI, labels, borders, watermark, fog, vignette, spotlight beam crossing the scene, camera change, or new landmarks. Keep the same restrained editorial gouache, screen-print texture, dry-brush softness, and aged-paper grain. Change only lighting and atmosphere; keep all geography and geometry unchanged.”
