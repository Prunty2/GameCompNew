...
- Runtime files: `fish-white-sucker-swim.png` (768 × 384 RGB chroma-matte sheet) and `fish-white-sucker-ui.png` (256 × 256 RGBA neutral-pose derivative)
...
- Runtime processing: the authoring sheet was proportionally downscaled to 768 px wide. The uniform magenta matte is keyed in memory for fishing, while the UI derivative was mechanically cropped from frame zero, chroma-keyed, proportionally resized, and centered without redrawing the fish.
