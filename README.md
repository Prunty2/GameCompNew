...
- A deterministic dockside buyer who occasionally requests two to four reachable fish at −10% to +25% of the current market quote
...
- Version 16 validated persistence, Tauri display settings, and a local-safe CrazyGames SDK v3 adapter
